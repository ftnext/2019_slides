...
- @color[#3A8687](機械学習モデルの作成)と@color[#3A8687](アプリケーションへの組み込み)を話します
...
- @color[#3A8687](AWS初学者、Amazon MLは業務で調査)
...
1. @color[#3A8687](機械学習 in Amazon ML)
2. Amazon MLの特徴
3. 機械学習モデルを組み込んだWebアプリ（デモ）
4. まとめ
...
- @color[#3A8687](知っているデータから知らないデータを予測)
...
2. @color[#3A8687](モデル)で知らないデータについて予測する
...
1. 機械学習 in Amazon ML
2. Amazon MLの特徴
3. @color[#3A8687](機械学習モデルを組み込んだWebアプリ（デモ）)
4. まとめ
...
- @color[#3A8687](「あなたがタイタニックに乗っていたら助かるでしょうか？」)
- AWS Lambdaにデプロイ
- 言語：Python
- フレームワーク：Flask
