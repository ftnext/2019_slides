...
図：エクスプローラーやFinderを使わなくてもエディタからファイルやフォルダを作れます
...
図
Djangoの動きとして、URLに対応するビューが呼び出され、必要なモデルにアクセス、取得した結果をテンプレートに渡し、HTMLを生成して返す
